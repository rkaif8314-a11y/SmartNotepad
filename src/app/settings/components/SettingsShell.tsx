...
import { Palette, Type, Search, User, Keyboard, Info, ChevronRight, ArrowLeft, LogOut, Save, RefreshCw } from 'lucide-react';
...
export type SettingsCategory = 'appearance' | 'editor' | 'search' | 'account' | 'shortcuts' | 'about';
...
const NAV_ITEMS: { key: SettingsCategory; label: string; icon: React.ElementType; description: string }[] = [
  ...
  { key: 'about', label: 'About App', icon: Info, description: 'SmartNotepad, features, privacy' },
];
